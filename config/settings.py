...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.site_settings.context_processors.business_settings',
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='cookieslab_web'),
...
ADMIN_SITE_HEADER = 'CookiesLab Admin'
ADMIN_SITE_TITLE = 'CookiesLab'
